...
export const translations = {
  ko: {
    ...
    'home.card.uuidv7.desc': '시간순 정렬이 쉬운 UUID v7 생성.',
    ...
    'query.title': 'URL 쿼리 생성기',
    'query.description': 'URL 쿼리 파라미터를 만들고 인코딩하는 URL 쿼리 생성기입니다.',
    'query.base': 'Base URL',
    'query.add': '파라미터 추가',
    'query.build': 'URL 생성',
    'query.output': '결과 URL',
    ...
    'uuidv7.description': '시간순 정렬에 유리한 UUID v7을 생성하는 UUID v7 생성기입니다.',
    'uuidv7.count': '생성 개수',
    'uuidv7.generate': '생성',
  ...
  en: {
    ...
    'query.description': 'Build encoded query strings and shareable URLs from key-value pairs.',
    'query.base': 'Base URL',
    ...
    'uuidv7.description': 'Generate time-sortable UUID v7 values in the browser.',
    'uuidv7.count': 'Count',
