...
const translations = {
  ko: {
    ...
    'home.card.seocheck.title': 'SEO 퀵체크',
    'home.card.seocheck.desc': 'Title/Description/OG/Canonical 진단.',
    'home.card.utm.title': 'UTM 빌더',
    'home.card.utm.desc': '캠페인 URL 생성 + 단축 코드 시뮬레이터.',
    'home.card.textcleaner.title': '텍스트 정리기',
    'home.card.textcleaner.desc': '중복 제거, 공백 정리, 정렬, slugify.',
    'home.card.apitester.title': 'API 테스터',
    'home.card.apitester.desc': 'HTTP 요청 테스트 + cURL 변환.',
    ...
    'api.title': 'API 테스터',
    'api.description': 'HTTP 요청을 보내고 응답을 확인한 뒤 cURL 명령으로 정리합니다.',
    ...
    'ocr.description': '이미지에서 한국어와 영어 텍스트를 추출합니다.',
    'ocr.file': '이미지 파일',
    'ocr.language': '언어',
    'ocr.langBoth': '한국어 + 영어',
    'ocr.langEnglish': '영어',
    ...
    'seo.title': 'SEO 퀵체크',
    'seo.description': 'URL 또는 HTML 소스로 메타 태그를 빠르게 진단합니다.',
    'seo.html': 'HTML 소스(선택)',
    'seo.run': '점검',
    'seo.output': '결과',
    ...
    'utm.title': 'UTM 빌더',
    'utm.description': '캠페인 URL을 만들고 짧은 코드 형태도 함께 확인합니다.',
    'utm.build': 'URL 생성',
  ...
  en: {
    ...
    'home.card.seocheck.title': 'SEO Quick Check',
    'home.card.seocheck.desc': 'Audit title, description, OG, and canonical tags.',
    'home.card.utm.title': 'UTM Builder',
    ...
    'home.card.apitester.title': 'API Tester',
    'home.card.apitester.desc': 'Test HTTP requests and export them as cURL commands.',
    ...
    'seo.title': 'SEO Quick Check',
    'seo.description': 'Quickly inspect meta tags from a URL or pasted HTML source.',
    ...
    'utm.description': 'Build campaign URLs and preview a short-code style result.',
    'utm.build': 'Build URL',
