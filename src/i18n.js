...
const translations = {
  ko: {
    ...
    'home.card.aihub.desc': 'Claude Code와 Codex 명령어, 설정, 공식 문서 링크를 한 곳에서 확인.',
    'home.card.claude.title': 'Claude Code 명령어',
    'home.card.claude.desc': '/clear, /compact, MCP, hooks, skills 같은 Claude Code 사용법 정리.',
    'home.card.codex.title': 'Codex 명령어',
    'home.card.codex.desc': 'codex CLI, /mode, /personality, Skills, Automations 빠른 참고.',
  ...
  en: {
    ...
    'home.card.aihub.desc': 'Find Claude Code and Codex commands, settings, and official docs in one place.',
    'home.card.claude.title': 'Claude Code Commands',
    'home.card.claude.desc': 'Quick reference for /clear, /compact, MCP, hooks, skills, and project routines.',
    'home.card.codex.title': 'Codex Commands',
    'home.card.codex.desc': 'Fast reference for codex CLI, /mode, /personality, Skills, and Automations.',
