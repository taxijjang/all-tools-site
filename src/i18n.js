...
const translations = {
  ko: {
    ...
    'home.card.qr.desc': '텍스트로 QR 생성, 이미지 업로드로 QR 스캔.',
    ...
    'home.card.jsonyaml.desc': '설정 파일 포맷을 양방향 변환.',
  ...
  en: {
    ...
    'home.card.qr.desc': 'Generate QR from text and scan QR from image uploads.',
    ...
    'home.card.jsonyaml.desc': 'Convert config formats both ways.',
