...
export const HOME_DISCOVERY_COPY = {
  ko: {
    kicker: 'Tool Search',
    heading: '지금 필요한 도구를 바로 찾으세요',
    lead: '검색으로 시작하고, 자주 쓰는 도구부터 빠르게 실행하세요.',
    ...
    catalogHeading: '추천 도구',
    catalogAllHeading: '전체 도구',
    catalogLink: '가이드',
    ...
    resultsFeatured: '전체 {total}개 중 자주 쓰는 {shown}개를 먼저 보여드립니다.',
    expandCatalog: '전체 {count}개 도구 보기',
    collapseCatalog: '추천 도구만 보기',
    resultsEmpty: '맞는 도구가 없습니다. 다른 키워드로 찾아보세요.',
  },
  en: {
    kicker: 'Tool Search',
    heading: 'Find the tool you need right now',
    lead: 'Start with search, then open the tools you reach for most.',
    spotlightKicker: 'Start Here',
    ...
    catalogKicker: 'Tool Catalog',
    catalogHeading: 'Recommended tools',
    catalogAllHeading: 'All tools',
    catalogLink: 'Guides',
    workflowEyebrow: 'Workflow',
    ...
    resultsFeatured: 'Showing {shown} frequently used tools from {total}.',
    expandCatalog: 'View all {count} tools',
    collapseCatalog: 'Show recommended tools',
