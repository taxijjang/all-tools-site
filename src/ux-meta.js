...
export const HOME_SEARCH_KEYWORDS = {
  ...
  '/age-guide': '만나이 만 나이 계산법 세는나이 연나이 나이계산 빠른년생 청소년보호법 병역법 age',
  '/cron-guide': '크론탭 크론 cron crontab 표현식 스케줄러 배치 타임존 겹침 crontab guide',
  '/date-calc': '만나이 만 나이 계산기 나이계산 세는나이 연나이 날짜계산 날짜차이 디데이 dday d-day age calculator date difference',
